<%-- 
    Document   : reg_form
    Created on : Jun 30, 2019, 2:29:44 PM
    Author     : 55ans
--%>
    ...
    <head>
        ...
        <script>
            $(document).ready(function (){
                 <s:url var="url_check_avail" value="/admin/check_avail"/>
                    ...
                    <f:form action="${url_reg}" modelAttribute="command" >
                        <table border="1">
                            ...
                            <tr>
                                ...
                                <!--login Name is same name which we used in User  Command and user is object of that class ---> 
